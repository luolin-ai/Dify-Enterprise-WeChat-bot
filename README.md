...
🔗 [下载企业微信 4.1.33.6009](https://dldir1.qq.com/wework/work_weixin/WeCom_4.1.33.6009.exe)
...
> 💡 **温馨提示**：添加小助手入群时，请备注 **Dify**，扫码入交流群时请备注来源。

<div align="center">
  <img src="8b2ea28b6b15d8a9735bd224ac08a1ef.jpg" alt="微信二维码" width="300"/>
</div>
...
<div align="center">
  <img src="77b6fea6b5c636f8a8956ff52dfbd13e.jpg" alt="赞助" width="300"/>
</div>
...
> 💡 **提示**：本版本即将更新以下功能，如需快速体验可先点击下方项目进行抢先体验 NextFlow-APP 版本。

**NextFlow-APP V1.0.07-beta.1 更新说明**：
- 🔗 [下载地址](https://github.com/luolin-ai/Enterprise-WeChat-GPTbot/releases/tag/1.0.07-beta.1)
...
- 修复部分 API 无法使用
- 新增文件发送群组 API，也可私发文件
- 兼容 [NextFlow](https://nextflow.app/) 新请求格式，可在 NextFlow 中管理企业微信的消息对应用户昵称 ID
  - 修复回复两次问题
...
6. **运行项目的 app 软件**
   ...
   **项目启动方式**：
   ...
   > ⚠️ 因企业微信特殊性，只支持 Windows 系统运行此项目
...
> ⚠️ 因 workflow 的特殊性，暂未开发完毕，开发完毕时将完善此处教程。
...
- **文件格式**：以日期为区分，每日的文件保存在一个 CSV 格式文件中
- **保存位置**：
...
|------|------|
| Group ID | 企业微信群聊 ID |
| Group Name | "Private Chat" 表示私聊，"群聊" 表示群聊 |
| Sender ID | 发送者，记录的是发送者的 wx_id |
| Sender Nickname | 发送者在企业微信上的昵称 |
| Message | 记录双方发送的信息 |
| Timestamp | 记录发送信息的时间，格式为 `{{YYYY/MM/DD HH:mm}}` |

> ⚠️ **需要注意的是**：本地保存的会话只作为会话留存，不会自动作为 AI 会话的知识库的数据支持。

---

## 📝 关于群里提问和 log 位置

在群里沟通的时候，如遇到问题，最好先看下 log 内容，对于常见问题，可以通过自行搜索解决。
